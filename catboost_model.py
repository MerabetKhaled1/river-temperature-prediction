...
grid = {'iterations': [80], 'learning_rate': [0.6], 'depth': [6], 'l2_leaf_reg': [0.05]}
...
with ExcelWriter('CatBoost01.xlsx') as writer:
    df11.to_excel(writer, sheet_name='CatBoost', startrow=3, startcol=2, header=False, index=False)
    df12.to_excel(writer, sheet_name='CatBoost', startrow=3, startcol=3, header=False, index=False)
