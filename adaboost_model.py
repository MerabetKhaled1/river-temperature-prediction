...
model = AdaBoostRegressor(random_state=0, n_estimators=200, learning_rate=2.0, loss='linear')
...
with ExcelWriter('AdaBoost01.xlsx') as writer:
    df11.to_excel(writer, sheet_name='AdaBoost', startrow=3, startcol=2, header=False, index=False)
    df12.to_excel(writer, sheet_name='AdaBoost', startrow=3, startcol=3, header=False, index=False)
